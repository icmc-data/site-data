          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="overflow-hidden hover:shadow-lg transition-shadow border border-border">
                <div className="aspect-video w-full overflow-hidden">
                  <img
                    src="/images/learn/sql2025Thumb.png"
                    alt="Data Analysis Course | PostgreSQL"
                    className="w-full h-full object-cover"
                  />
                </div>
                <CardContent className="p-6">
                  ...
                  <Link to="https://youtube.com/playlist?list=PLFE-LjWAAP9Ry9zwnjVOSgglOlw3y6g12&si=RBWK6xPnvxoDLxQl">
                    <Button
                      size="sm"
                      className="bg-data-purple hover:bg-data-purple/80"
                    >
              ...
              <Card className="overflow-hidden hover:shadow-lg transition-shadow border border-border">
                <div className="aspect-video w-full overflow-hidden">
                  <img
                    src="/images/learn/RL2025Thumb.png"
                    alt="Reinforcement Learning Course"
                    className="w-full h-full object-cover"
                  />
                </div>
                <CardContent className="p-6">
                  ...
                  <Link to="https://youtube.com/playlist?list=PLFE-LjWAAP9TKFzYmmRqvbIOXZpvkXd28&si=1_8J8z30FRUNZrx4">
                    <Button
                      size="sm"
                      className="bg-data-purple hover:bg-data-purple/80"
                    >
